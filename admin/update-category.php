...
<div class="main-content">
    <div class="wrapper">
        ...
        <?php //Check whether the id is set or not
        if (isset($_GET['id'])) {
        ...
        <?php if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                if ($image_name != '') {
                    ...
                    //Rename the Image
                    $image_name =
                        'Food_Category_' . rand(000, 999) . '.' . $ext; // e.g. Food_Category_834.jpg
                    ...
                    if ($upload == false) {
                        //SEt message
                        $_SESSION['upload'] =
                            "<div class='error'>Failed to Upload Image. </div>";
            ...
            if ($res2 == true) {
                //Category Updated
                $_SESSION['update'] =
                    "<div class='success'>Category Updated Successfully.</div>";
                header('location:' . SITEURL . 'admin/manage-categories.php');
            } else {
                //failed to update category
                $_SESSION['update'] =
                    "<div class='error'>Failed to Update Category.</div>";
                header('location:' . SITEURL . 'admin/manage-categories.php');
            }
        } ?>
